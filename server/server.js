...
// const session = require("express-session"); // express-session import edildi
...
// app.use(passport.session()); // Kalıcı login session'ları için

// app.use(cookieParser());
// app.use(express.json());
// app.use(express.urlencoded({ extended: true }));

// // --- YENİ: Session Middleware ---
// app.use(
//   session({
//     secret:
//       process.env.SESSION_SECRET ||
//       "f8492386349cb78bb1294aaa6891beda10e7f4c054df818088f36559e0bf7651e2a59fd5f", // Güçlü bir secret kullanın ve .env'ye taşıyın
//     resave: false, // Gerekmedikçe session'ı tekrar kaydetme
//     saveUninitialized: false, // Başlangıçta boş session kaydetme
//     cookie: {
//       secure: process.env.NODE_ENV === "production", // Production'da true olmalı (HTTPS için)
//       httpOnly: true, // Cookie'ye JS üzerinden erişimi engelle
//       maxAge: 1000 * 60 * 60 * 24, // Örnek: 1 gün (milisaniye cinsinden)
//       sameSite: "Lax", // CSRF koruması için
//     },
//   })
// );

// // --- YENİ: Passport Middleware ---
// app.use(passport.initialize()); // Passport'u başlat
// app.use(passport.session()); // Kalıcı login session'ları için
...
// Rota tanımlamalarını import et
const authRouter = require("./routes/auth/auth-routes");
const adminProductsRouter = require("./routes/admin/products-routes");
const adminOrderRouter = require("./routes/admin/order-routes");
const shopProductsRouter = require("./routes/shop/products-routes");
