...
function ProductTileSkeleton() {
  return (
    <Card className="w-full max-w-sm mx-auto flex flex-col h-full overflow-hidden border">
      ...
      {/* Resim Alanı */}
      <Skeleton className="w-full h-[250px] sm:h-[300px] rounded-t-lg rounded-b-none" />{" "}
      {/* Yükseklik product-tile ile aynı */}
      {/* İçerik Alanı */}
      <CardContent className="px-4 pt-3 pb-3 flex flex-col flex-grow space-y-2">
        {" "}
        {/* Padding ve boşluk ayarları */}
